...
path.to.anno.contigs <- file.path(path.to.VDJ.output, sprintf("annotated_contigs_clonaltype_%s.csv", str_replace(sample, "_2nd_round", "")))

path.to.count.clonaltype <- file.path(path.to.VDJ.output, sprintf("count_clonaltype_%s.csv", str_replace(sample, "_2nd_round", "")))
