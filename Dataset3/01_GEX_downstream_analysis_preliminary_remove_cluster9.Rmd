...
## UMAP: all clusters 
```{r UMAP_all_clusters_after_integrating, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.width=14, fig.height=10, dpi=300, dev='svg'}
...
```{r UMAP_all_samples_before_integrating, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.width=14, fig.height=10, dpi=300, dev='svg'}
...
```{r UMAP_all_samples_after_integrating, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.width=14, fig.height=10, dpi=300, dev='svg'}
...
```{r results='asis', echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=10, dpi=300, dev='svg'}
